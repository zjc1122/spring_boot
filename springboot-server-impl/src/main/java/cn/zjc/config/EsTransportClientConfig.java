 ...
 */
@Configuration
public class EsTransportClientConfig implements FactoryBean<TransportClient>, InitializingBean, DisposableBean {

    private static final Logger logger = LoggerFactory.getLogger(EsTransportClientConfig.class);
